...
let db = new sqlite3.Database('./db/DB.sqlite', () => {
  ...
  db.run('CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, codigo INTERGER NOT NULL, precio REAL NOT NULL, descripcion TEXT, sexo TEXT, empresa TEXT, caregory_id INTEGER, FOREIGN(category_id) REFERENCES categorias(id))');
